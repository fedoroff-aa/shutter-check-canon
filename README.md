...
- \<Список ошибок\> \ - список ошибок, которые произошли с камерой.
...
- E20 \- проблемы со шторкой, зеркалом или другими механизмами внутри камеры (опасная ошибка, вам следует обратить внимание, если у используемой камеры есть такой тип ошибки и более одного случая, также рекомендуется обратиться в сервисный центр, где квалифицированные специалисты могут проверить исправность камеры)
- E70 \- проблемы с перегревом (это не опасная ошибка, но имейте в виду, что обращение в сервисный центр при покупке дорогой вещи - хорошая практика)
